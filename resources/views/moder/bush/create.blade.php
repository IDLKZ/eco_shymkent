<x-app-layout>
    ...
    <div class="container mx-auto py-5">
        ...
        <form action="{{route("moder-bush-store")}}" id="area-form" method="post">
            @csrf
                ...
                <select id="place_ids" name="place_id" class="form-select select_2_form py-6" >
                    ...
                    @if(count($places))
                        @foreach($places as $placeItem)
                            <option data-area="{{$placeItem}}" value="{{$placeItem->id}}">
            ...
            <div class="relative mb-4">
                ...
                <select name="type_id" class="form-select select_2_form py-6" >
                    <option value="">Не выбрано</option>
                    @if(count($types))
            ...
            <div class="relative mb-4">
                <label>Вид посадки</label>
                <select name="breed_id" class="form-select select_2_form py-6" >
                    <option value="">Не выбрано</option>
                    @if(count($breeds))
            ...
            <div class="relative mb-4">
                <label>Вид состояний</label>
                <select name="sanitary_id" class="form-select select_2_form py-6" >
                    <option value="">Не выбрано</option>
                    @if(count($sanitaries))
